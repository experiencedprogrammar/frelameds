...
<head>
  ...
  <title>FrelaAdmin Dashboard</title>
...
<body>
  <!-- Header -->
  <header class="header">
    <div class="logo"><img src="{{ asset('frontend/img/logo3.png') }}" alt="Frela Admin Logo"></div>
    <div class="user-area">
      <div class="user-info">
        <span class="user-name">Dr. JJ</span>
  ...
  <aside class="sidebar">
    <nav class="sidebar-menu">
      ...
      <a class="menu-item" data-content="appointments" data-src="/admin/appointments"><i class="fas fa-user-md"></i><span class="menu-text">Appointments</span></a>
      <!-- Users Dropdown -->
      ...
      <div class="menu-dropdown">
        <a class="menu-item dropdown-toggle"><i class="fas fa-pills"></i><span class="menu-text">Products</span><i class="fas fa-chevron-down dropdown-arrow"></i></a>
        <div class="submenu">
      ...
      <a class="menu-item" data-content="orders" data-src="{{ route('admin.orders.view') }}"><i class="fas fa-shopping-cart"></i><span class="menu-text">Orders</span></a>
      <a class="menu-item" data-content="suppliers" data-src="/admin/suppliers"><i class="fas fa-truck"></i><span class="menu-text">Suppliers</span></a>
      ...
      <a class="menu-item" data-content="help" data-src="/admin/help"><i class="fa fa-envelope"></i><span class="menu-text">Inbox</span></a>
      <a class="menu-item" data-content="logout" data-src="/logout"><i class="fas fa-sign-out-alt"></i><span class="menu-text">Logout</span></a>
    </nav>
  </aside>
  ...
  <main class="main-content">
    ...
    <div id="dashboard-content" class="dashboard-content">
      <div class="card-grid">
        <div class="card green">Total Sales</div>
        <div class="card blue">New Users</div>
        <div class="card red">Pending Orders</div>
        <div class="card teal">Appointments</div>
      </div>
